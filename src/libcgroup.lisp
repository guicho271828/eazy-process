...
;; added the package description manually

(defpackage :eazy-process.cgroup)
(in-package :eazy-process.cgroup)
(cffi:define-foreign-library cgroup
  (:linux (:or "libcgroup.so.1.0.38" "libcgroup.so.1" "libcgroup.so")))
(cffi:use-foreign-library cgroup)
